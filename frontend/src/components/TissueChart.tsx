...
const TissueChart: React.FC<Props> = ({ data }) => {
  return (
    <div style={{ width: '100%', height: 300, backgroundColor: '#1a1a1a', padding: '10px', borderRadius: '8px' }}>
      <h3 style={{ color: '#00ffcc', margin: '0 0 10px 0', fontSize: '14px', fontFamily: 'monospace' }}>TISSUE SATURATION (% M-VALUE SURF)</h3>
